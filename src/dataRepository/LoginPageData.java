...
public class LoginPageData {
      public final static String USERID_LABEL = "User ID";
      public final static String PASSWORD_LABEL = "Password";
      public final static String FORGOT_USERID_LINK_TEXT = "Forgot User ID?";
      public final static String FORGOT_PASSWORD_LINK_TEXT = "Forgot Password?";
      public final static String SIGNUP_BUTTON_TEXT = "Sign Up";
